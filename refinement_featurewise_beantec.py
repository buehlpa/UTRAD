...
def main():
    ...
    if argu.category==1 or argu.category=='1':
        argu.category='01'
    if argu.category==2 or argu.category=='2':
        argu.category='02'
    if argu.category==3 or argu.category=='3':
        argu.category='03'
    ...
    if argu.mode=='own':
        ...
        paths=[f'/home/bule/projects/UTRAD/results/beantec/contamination_10/Exp_18_06_24_run_{i}-{category}/experiment_paths.json' for i in range(1,6)]
        ...
        for path in paths:
            ...
            if argu.category=='03':
                print(True)
                experiment['train']=[path for path in experiment['train'] if 'bmp' not in path]   
                 
            print(len(experiment['train']))
            ############################################################################## OWN REFINEMENT FUNCTION
            experiment_refined=refine_paths(experiment,args) 
            labels=[0 if 'ok' in path else 1 for path in experiment['train']]
            data['paths'].append(experiment['train'])
            ...
            img_list = [load_image(path, aligned=True) for path in experiment['train']]
        ...
        filename = f'/home/bule/projects/UTRAD/results/beantec/refinement/Refinement_Comparison_{category}.pkl'
    ...
    if argu.mode=='vit_beans':
        ...
        path=f'/home/bule/projects/UTRAD/results/beantec/contamination_10/Exp_18_06_24_run_{argu.run}-{category}/experiment_paths.json' 
        ...
        filename = f'/home/bule/projects/UTRAD/results/beantec/refinement/Refinement_Comparison_SOTA_{category}.pkl'
    ...
    if argu.mode=='vit_imagenet': 
        ...
        filename = f'/home/bule/projects/UTRAD/results/beantec/refinement/Refinement_Comparison_SOTA_imagenet_{category}.pkl'
