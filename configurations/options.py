...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--fixed_seed_bool',type=self.str2bool, default=True, help='whether to use fixed seed, if False, seed and seed_test is set to time.time()')
        self.parser.add_argument('--fixed_seed_TEST_bool',type=self.str2bool, default=True, help='control seed for testset')
        self.parser.add_argument('--fixed_seed_TRAIN_bool',type=self.str2bool, default=True, help='control overall seed')        
        ...
        self.parser.add_argument('--use_synthetic', type=bool, default=False, help='bool to use synthetic data , experimental')
        self.parser.add_argument('--synthetic_ratio', type=float, default=0.5, help='1-synthetic_ratio = probaility that a sythethic image is used during training')
